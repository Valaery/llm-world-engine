...
- [[LLM World Engine/prompts/00-PROMPT-INDEX|00-PROMPT-INDEX]] - Full prompt library from Discord
- [[LLM World Engine/prompts/narration/NDL-to-Narrative|NDL-to-Narrative Prompt]] - Matches NPC turn system
- [[LLM World Engine/prompts/generation/Character-Generation|Character Generation Prompt]] - Matches generate_actor.py
- [[LLM World Engine/prompts/generation/Template-Meta-Generation|Template Meta-Generation]] - Matches random_list generator

**Related ChatBotRPG Analysis**:
- [[chatbotrpg-analysis/analysis/03-Prompt-Implementation|03-Prompt-Implementation]] - Full implementation details
- [[chatbotrpg-analysis/analysis/02-Pattern-Implementation|02-Pattern-Implementation]] - How prompts connect to patterns
- [[chatbotrpg-analysis/analysis/04-Code-Examples|04-Code-Examples]] - Working examples from these files
